...
public class NexusDbContext : DbContext
{
    ...
    public DbSet<RetweetEntity> Retweets => Set<RetweetEntity>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.UserId);
            entity.Property(e => e.PrivacyLevel).HasMaxLength(40);
        ...
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Tag).IsRequired().HasMaxLength(60);
            entity.HasIndex(e => new { e.PostId, e.Tag }).IsUnique();
        ...
        modelBuilder.Entity<NotificationEntity>(entity =>
        {
            ...
            entity.Property(e => e.Preview).HasMaxLength(300);
        ...
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Device).IsRequired().HasMaxLength(120);
            entity.Property(e => e.IconGlyph).HasMaxLength(10);
            entity.Property(e => e.Location).HasMaxLength(120);
            entity.Property(e => e.Expiry).HasMaxLength(40);
            entity.HasOne(e => e.User)
        ...
        modelBuilder.Entity<RetweetEntity>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.HasIndex(e => new { e.OriginalPostId, e.UserId }).IsUnique();
            entity.HasOne(e => e.OriginalPost)
                .WithMany(e => e.Retweets)
